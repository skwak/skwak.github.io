...
- **Seoul Science High School**
  - Research on mathematical morphing algorithm for shape transformation from embryo to zebra – *2024*
  - An efficient and fast Voronoi diagram generation algorithms – *2023*
  - 편미분 방정식을 이용한 쪽지문 (partial fingerprint) 복원 방법 연구 – *2022*
...
- **Incheon Academy of Science and Arts**
  ...
  - AI의 기본 수학적 원리 탐구와 편미분 방정식을 활용한 날씨 분류 알고리즘 연구 - *2025*
  - 머신러닝에 적용되는 그래디언트 플로우의 수치기법 연구 - *2024*
  - 머신러닝의 수학적 기본원리 학습, 다양한 플랫폼 (옥타브, 매트랩, 파이썬, 텐서플로)으로 프로그램 구현 및 학습 데이터 직접 제작 체험 - *2023*
  - 데이터 과학에 활용되는 머신러닝의 수학적 원리와 코딩 - *2022*
